syntax "**/*.rs" {
	keywords = {fn|let|const|static|if|else|match|loop|while|for|break|continue|return|mod|use|as|in|enum|struct|trait|type|impl|where|mut|ref|pub|unsafe|extern}
